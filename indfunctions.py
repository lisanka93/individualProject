...
def demo():
	...
	for file in os.listdir(directory):
		...
		av_ne = (float(len(named_entities)) / argument_counter)
		...
		for i in range(2, end+1, 1):
			...
			average_freq = average_freqdist(lemma_sent, no_stop_lemmatised)
			...
			#VECTOR STRING
			vector_string_static = str(argu_length) + "," + str(linkwords) + "," + str(readability) + "," + str(badword) + "," + str(spellcheck) + "," + str(punctu) + "," + str(hyperlink_p) + "," + str(caps) + "," +str(named_e) + "," + str(percent_inter)  + "," + str(percent_interII) + "," + str(percent_interIII) + "," + str(percemt_g1) + "," + str(percemt_g2)
